% Setting all the global variables for DAG #8
%
% DAG #8 describes a Gaussian elimination workflow with V = 14 tasks.
%
%  ***************************************************
%  * Package: VirtFogSim                             *
...
%
V = 14;  % Positive scalar integer value. It is the number of tasks of the 
...
k2 = 1;
%
s = k1*c1*[5,320*ones(1,4),30,60*ones(1,3),70,30*ones(1,2),30,5]; %DAG_Y (workflow of the Gaussian Elimination Algorithm of size: 5x5)
...
%
A = [0,  ones(1,4),  zeros(1,9);          %%DAG_Y (workflow of the Gaussian Elimination Algorithm of size: 5x5)
     zeros(1,5),  1, zeros(1,8);
     zeros(1,6),  1, zeros(1,7);
     zeros(1,7),  1, zeros(1,6);
     zeros(1,8),  1, zeros(1,5);
     zeros(1,6),  1, 1, 1, zeros(1,5);
     zeros(1,9),  1, zeros(1,4);
     zeros(1,10), 1, zeros(1,3);
     zeros(1,11), 1, zeros(1,2);
     zeros(1,10), 1, 1, 0, 0;
     zeros(1,12), 1, 0;
     zeros(1,13), 1;
     zeros(1,13), 1;
...
%
Da = k2*c2*[0, 15*ones(1,4), zeros(1,9); %DAG_Y (workflow of the Gaussian      Elimination Algorithm of size: 5x5)
     zeros(1,5),  150, zeros(1,8);
     zeros(1,6),  150, zeros(1,7);
     zeros(1,7),  150, zeros(1,6);
     zeros(1,8),  150, zeros(1,5);
     zeros(1,6),  50,  50, 50, zeros(1,5);
     zeros(1,9),  100, zeros(1,4);
     zeros(1,10), 100, zeros(1,3);
     zeros(1,11), 100, zeros(1,2);
     zeros(1,10), 125, 125, 0, 0;
     zeros(1,12), 100, 0;
     zeros(1,13), 100;
     zeros(1,13), 100;
     zeros(1,14)];
...
%
a_max = 1.45e-7; % Dimension-less positive scalar real parameter, 
...
%
%
a_max_vec_FT = [1.66e-7, 1.45e-7, 1.29e-7];  
