% Setting all the global variables for DAG #14
%
% DAG #14 describes an Epigenomics workflow with V = 45 tasks.
%
%  ***************************************************
%  * Package: VirtFogSim                             *
...
%
V = 45;  % Positive scalar integer value. It is the number of tasks of the 
...
k2 = 1;
%
s = k1*c1*[30, 34*ones(1,10), 25*ones(1,10), 35*ones(1,10), 33*ones(1,10), 20*ones(1,2), 318, 2]; 
%DAG_C (Epigenomics workflow)
...
%
A = [0, ones(1,10), zeros(1,34);          %DAG_C (Epigenomics workflow)
     zeros(1,11),1, zeros(1,33);
     zeros(1,12),1, zeros(1,32);
     zeros(1,13),1, zeros(1,31);
     zeros(1,14),1, zeros(1,30);
     zeros(1,15),1, zeros(1,29);
     zeros(1,16),1, zeros(1,28);
     zeros(1,17),1, zeros(1,27);
     zeros(1,18),1, zeros(1,26);
     zeros(1,19),1, zeros(1,25);
     zeros(1,20),1, zeros(1,24);
     zeros(1,21),1, zeros(1,23); 
     zeros(1,22),1, zeros(1,22);
     zeros(1,23),1,zeros(1,21);
     zeros(1,24),1,zeros(1,20);
     zeros(1,25),1,zeros(1,19);
     zeros(1,26),1,zeros(1,18);
     zeros(1,27),1,zeros(1,17);
     zeros(1,28),1,zeros(1,16);
     zeros(1,29),1,zeros(1,15);
     zeros(1,30),1,zeros(1,14);
     zeros(1,31),1,zeros(1,13);
     zeros(1,32),1,zeros(1,12);
     zeros(1,33),1,zeros(1,11);
     zeros(1,34),1,zeros(1,10);
     zeros(1,35),1,zeros(1,9);
     zeros(1,36),1,zeros(1,8);
     zeros(1,37),1,zeros(1,7);
     zeros(1,38),1,zeros(1,6);
     zeros(1,39),1,zeros(1,5);
     zeros(1,40),1,zeros(1,4);
     zeros(1,41),1,zeros(1,3);
     zeros(1,41),1,zeros(1,3);
     zeros(1,41),1,zeros(1,3);
     zeros(1,41),1,zeros(1,3);
     zeros(1,41),1,zeros(1,3);
     zeros(1,42),1,zeros(1,2);
     zeros(1,42),1,zeros(1,2);
     zeros(1,42),1,zeros(1,2);
     zeros(1,42),1,zeros(1,2);
     zeros(1,42),1,zeros(1,2);
...
%
Da = k2*c2*[0, 17*ones(1,10), zeros(1,34);  %DAG_C (Epigenomics workflow)
     zeros(1,11),47, zeros(1,33);
     zeros(1,12),47, zeros(1,32);
     zeros(1,13),47, zeros(1,31);
     zeros(1,14),47, zeros(1,30);
     zeros(1,15),47, zeros(1,29);
     zeros(1,16),47, zeros(1,28);
     zeros(1,17),47, zeros(1,27);
     zeros(1,18),47, zeros(1,26);
     zeros(1,19),47, zeros(1,25);
     zeros(1,20),47, zeros(1,24);
     zeros(1,21),4.4, zeros(1,23); 
     zeros(1,22),4.4, zeros(1,22);
     zeros(1,23),4.4,zeros(1,21);
     zeros(1,24),4.4,zeros(1,20);
     zeros(1,25),4.4,zeros(1,19);
     zeros(1,26),4.4,zeros(1,18);
     zeros(1,27),4.4,zeros(1,17);
     zeros(1,28),4.4,zeros(1,16);
     zeros(1,29),4.4,zeros(1,15);
     zeros(1,30),4.4,zeros(1,14);
     zeros(1,31),91,zeros(1,13);
     zeros(1,32),91,zeros(1,12);
     zeros(1,33),91,zeros(1,11);
     zeros(1,34),91,zeros(1,10);
     zeros(1,35),91,zeros(1,9);
     zeros(1,36),91,zeros(1,8);
     zeros(1,37),91,zeros(1,7);
     zeros(1,38),91,zeros(1,6);
     zeros(1,39),91,zeros(1,5);
     zeros(1,40),91,zeros(1,4);
     zeros(1,41),0.5,zeros(1,3);
     zeros(1,41),0.5,zeros(1,3);
     zeros(1,41),0.5,zeros(1,3);
     zeros(1,41),0.5,zeros(1,3);
     zeros(1,41),0.5,zeros(1,3);
     zeros(1,42),0.5,zeros(1,2);
     zeros(1,42),0.5,zeros(1,2);
     zeros(1,42),0.5,zeros(1,2);
     zeros(1,42),0.5,zeros(1,2);
     zeros(1,42),0.5,zeros(1,2);
...
%
%
a_max_vec_FT = [2.8013e-7,2.25e-7,2.10e-7];  
