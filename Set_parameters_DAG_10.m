% Setting all the global variables for DAG #10
%
% DAG #10 describes an FFT workflow with V = 18 tasks.
%
%  ***************************************************
%  * Package: VirtFogSim                             *
...
%
V = 18;  % Positive scalar integer value. It is the number of tasks of the 
...
k2 = 1;
%
s = k1*c1*[5, 10, 10, 380*ones(1,4), 10*ones(1,4),10*ones(1,4), 15, 15, 5]; %DAG_X (FFT-4 workflow)
...
%
A = [0, 1, 1, zeros(1,15);          %DAG_X (FFT-4 workflow)
     zeros(1,3),  1, 1, zeros(1,13);
     zeros(1,5),  1, 1, zeros(1,11);
     zeros(1,7),  1, 1, zeros(1,9);
     zeros(1,7),  1, 1, zeros(1,9);
     zeros(1,9),  1, 1, zeros(1,7);
     zeros(1,9),  1, 1, zeros(1,7);
     zeros(1,11), 1, 0, 1, zeros(1,4);
     zeros(1,12), 1, 0, 1, zeros(1,3);
     zeros(1,11), 1, 0, 1, zeros(1,4);
     zeros(1,12), 1, 0, 1, zeros(1,3);
     zeros(1,15), 1, 0, 0;
     zeros(1,15), 1, 0, 0;
...
%
Da = k2*c2*[0, 100, 100, zeros(1,15);          %DAG_X (FFT-4 workflow)
     zeros(1,3),  15, 15, zeros(1,13);
     zeros(1,5),  15, 15, zeros(1,11);
     zeros(1,7),  72.5, 72.5, zeros(1,9);
     zeros(1,7),  72.5, 72.5, zeros(1,9);
     zeros(1,9),  72.5, 72.5, zeros(1,7);
     zeros(1,9),  72.5, 72.5, zeros(1,7);
     zeros(1,11), 36, 0, 36, zeros(1,4);
     zeros(1,12), 36, 0, 36, zeros(1,3);
     zeros(1,11), 36, 0, 36, zeros(1,4);
     zeros(1,12), 36, 0, 36, zeros(1,3);
     zeros(1,15), 70.5, 0, 0;
     zeros(1,15), 70.5, 0, 0;
...
%
a_max = 1.22e-7; % Dimension-less positive scalar real parameter, 
...
%
%
a_max_vec_FT = [1.30e-7,1.22e-7,1.0e-7];  
